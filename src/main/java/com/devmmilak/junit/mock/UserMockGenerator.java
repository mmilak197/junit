package com.devmmilak.junit.mock;


import com.devmmilak.junit.domain.Account;
import com.devmmilak.junit.domain.Permit;
import com.devmmilak.junit.domain.Sex;
...
public class UserMockGenerator implements IGenerator {
    ...
    public List<User> generate() {
        final var accounts = accountMockGenerator.generate();
